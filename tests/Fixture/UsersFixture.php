...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_type' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-03-13 18:54:59',
                'modified' => '2019-03-13 18:54:59'
            ],
        ];
        parent::init();
    }
