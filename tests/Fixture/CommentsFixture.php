...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'book_key' => ['type' => 'foreign', 'columns' => ['book_id'], 'references' => ['books', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2019-03-28 06:54:31',
                'modified' => '2019-03-28 06:54:31'
            ],
        ];
        parent::init();
    }
